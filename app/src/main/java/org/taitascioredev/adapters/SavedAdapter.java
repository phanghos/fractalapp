 ...
 */
public class SavedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements PopupMenu.OnMenuItemClickListener {

    private final int TYPE_SUBMISSION = 0;
    ...
    public SavedAdapter(AppCompatActivity context, Listing<Contribution> objects) {
    ...
    public int getItemViewType(int position) {
        //Contribution c = objects.get(position);
        if (objects.get(position) instanceof Submission) {
            return TYPE_SUBMISSION;
        }
        else if (objects.get(position) instanceof Comment) {
            return TYPE_COMMENT;
        }
        return -1;
    }
    ...
    private void showComment(final CommentViewHolder holder, final int position) {
        holder.popup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                menu.setOnMenuItemClickListener(SavedAdapter.this);
                MenuInflater inflater = menu.getMenuInflater();
                inflater.inflate(R.menu.popup_comment, menu.getMenu());
                menu.show();

                MenuItem item = menu.getMenu().findItem(R.id.permalink_comment);
                item.setVisible(false);
            }
        });

        //final Submission submission;
        final Comment comment = (Comment) objects.get(position);
        ...
        if (pref.equals("1")) {
            holder.card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("id", comment.getSubmissionId());
        ...
        */
        ...
        // domain
        String str = comment.getSubmissionTitle();
        ...
        */
        ...
        // author
        String text = "/u/" + comment.getSubmissionAuthor() + "  -  ";
        ...
        ssb.setSpan(clickSpan, 0, ("/u/" + comment.getSubmissionAuthor()).length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        holder.author.setText(ssb, TextView.BufferType.SPANNABLE);
        holder.author.setMovementMethod(LinkMovementMethod.getInstance());

        // subreddit
        text = "/r/" + comment.getSubredditName();
        ssb = new SpannableStringBuilder(text);
        ...
        clickSpan = new MyClickableSpan(context.getResources().getColor(R.color.colorDomain)) {
            ...
            public void onClick(View widget) {
                SubredditPageFragment fragment = new SubredditPageFragment();
                Bundle bundle = new Bundle();
                bundle.putString("subreddit_url", comment.getSubredditName());
                fragment.setArguments(bundle);
                context.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, fragment).addToBackStack(null).commit();
            }
        };
        ...
        holder.commentBody.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.commentBody.setText(Utils.setUrlSpans(context, spanned, false));
            }
        });
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.permalink_submission:
                ...
                data = ClipData.newPlainText("permalink", baseUrl + submission.getPermalink());
            ...
            case R.id.permalink_comment:
                clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
                data = ClipData.newPlainText("permalink", baseUrl + comment.getId());
                clipboard.setPrimaryClip(data);
                Toast.makeText(context, "Permalink copied to the clipboard", Toast.LENGTH_SHORT).show();
                return true;
                */
