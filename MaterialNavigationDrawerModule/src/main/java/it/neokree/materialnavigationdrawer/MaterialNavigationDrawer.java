...
public abstract class MaterialNavigationDrawer<Fragment> extends ActionBarActivity implements MaterialSectionListener,MaterialAccount.OnAccountDataLoaded {
    ...
    public List<Fragment> getChildFragmentStack() { return childFragmentStack; }
    public boolean isCurrentFragmentChild() { return isCurrentFragmentChild; }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            isCurrentFragmentChild = Utils.isCurrentFragmentChild;
            multiPaneSupport = Utils.multiPaneSupport;
            //childFragmentStack = Utils.childFragmentStack;
            //childTitleStack = Utils.childTitleStack;
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Utils.isCurrentFragmentChild = isCurrentFragmentChild;
        Utils.multiPaneSupport = multiPaneSupport;
        Utils.childFragmentStack = childFragmentStack;
        Utils.childTitleStack = childTitleStack;
